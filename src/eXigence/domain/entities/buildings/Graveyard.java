...
/**
 * Repräsentiert das Gebäude Friedhof für die Simulation
 * 
 * @author Lars George
 *
 */
@Entity
public class Graveyard extends ExigenceBuilding
{			
	// ------------------------------------------------------------------------
	// Konstruktor
	// ------------------------------------------------------------------------
	public Graveyard(Vector2D position, Vector2D heading)
	{		
		super(position, heading, "", 0, 0);
		
		loadValuesFromConfig("Graveyard");
	}
