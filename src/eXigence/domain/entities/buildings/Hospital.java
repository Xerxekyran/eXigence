...
/**
 * Repräsentiert das Gebäude Krankenhaus für die Simulation
 * 
 * @author Lars George
 *
 */
@Entity
public class Hospital extends ExigenceBuilding
{		
	
	// ------------------------------------------------------------------------
	// Konstruktor
	// ------------------------------------------------------------------------
	public Hospital(Vector2D position, Vector2D heading)
	{		
		super(position, heading, "", 0, 0);
		
		loadValuesFromConfig("Hospital");
	}
