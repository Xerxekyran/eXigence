...
/**
 * Repräsentiert das Gebäude Hotel für die Simulation
 * 
 * @author Lars George
 *
 */
@Entity
public class Hotel extends ExigenceBuilding
{		

	// ------------------------------------------------------------------------
	// Konstruktor
	// ------------------------------------------------------------------------
	public Hotel(Vector2D position, Vector2D heading)
	{		
		super(position, heading, "", 0, 0);
		
		loadValuesFromConfig("Hotel");
	}
	...
	public boolean enterBuilding(ExigenceCharacter interactingPlayer)
	{
		...
		interactingPlayer.setNecessitiySleep(0);
		interactingPlayer.setNecessitiyEnjoyment(100);
